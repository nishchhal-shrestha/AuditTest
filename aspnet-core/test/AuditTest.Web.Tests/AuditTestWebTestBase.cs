...
{
    public abstract class AuditTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AuditTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AuditTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AuditTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AuditTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AuditTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AuditTestDbContext, Task<T>> func)
        {
            T result;
